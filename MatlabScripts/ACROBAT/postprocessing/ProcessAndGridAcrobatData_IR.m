...
%we created the stuff that eventually creates the tpCTD. There probably is a better way to fix the code, that
%gets rid of this funky nan buisness. I think it could be done by modifying
%the way the tpCTD gets created, 139 to 168. or how we create cc in line
%72.
%************
